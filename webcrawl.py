...
def scrap(location, checkIn, checkOut, start):
    ...
    with sync_playwright() as p:
        ...
        page_url = f'https://www.booking.com/searchresults.en-us.html?checkin={checkIn}&checkout={checkOut}&ss={location}&lang=en-us&group_adults=2&no_rooms=1&group_children=0&sb_travel_purpose=leisure'
...
"""if __name__ == '__main__':
    scrap("Changhua", "2023-11-19", "2023-11-20", time.time())"""
